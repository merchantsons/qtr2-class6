  ...
  return (
    <div className='mx-auto pb-[4vmin] pt-[10vmin] bg-[#F3F3F3]'>
      <div className='flex flex-col lg:flex-row items-center'>
        {/* Left Column */}
        <div className='w-full lg:w-1/2 ml-0 lg:ml-[35vmin] text-center lg:text-left px-4 bg-[#F3F3F3]'>
          <div className='font-poppins text-sm lg:text-left'>02 / PROJECT NAME</div>
          <div className='font-poppins text-sm lg:w-[33vmin] lg:mt-[3vmin]'>Subsurface weight, specular roughness, diffuse maps generated with the procedure and manual techniques.</div>
          <div className='font-poppins text-[#606060] text-xs lg:w-[33vmin] lg:mt-[4vmin]'></div>
          <div className='font-poppins text-sm mt-[25vmin] hover:underline cursor-pointer'>See case study →</div>
        </div>     
